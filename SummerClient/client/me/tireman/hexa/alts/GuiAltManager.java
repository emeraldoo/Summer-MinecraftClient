...
import ch.SummerClient.ClientMain;
import ch.SummerClient.utils.RenderUtils;
...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                AltManager altManager = ClientMain.getInstance().altManager;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 =ClientMain.getInstance().altManager;
